...
using Nikan.Services.Identity.STS.Identity.Configuration;
using Nikan.Services.Identity.STS.Identity.Configuration.ApplicationParts;
using Nikan.Services.Identity.STS.Identity.Configuration.Constants;
using Nikan.Services.Identity.STS.Identity.Configuration.Interfaces;
using Nikan.Services.Identity.STS.Identity.Helpers.Localization;
...
namespace Nikan.Services.Identity.STS.Identity.Helpers
{
